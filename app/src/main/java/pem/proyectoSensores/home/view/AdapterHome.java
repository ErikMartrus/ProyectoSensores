package pem.proyectoSensores.home.view;
...
public class AdapterHome extends RecyclerView.Adapter<AdapterHome.FilaViewHolder> {

    private String[] items;
    private SeleccionListener oyente;

    public AdapterHome(Object[] datos, SeleccionListener oyente) {
        items = (String[])datos;
        this.oyente = oyente;
    }
